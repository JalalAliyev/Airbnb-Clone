    ...
    card1: [
      {
        ...
        description:
          "Uniqu activities we can do together, led by a world of hosts.",
      },
      {
        src:
      ...
      {
        src:
          "https://a0.muscache.com/im/pictures/fdb46962-10c1-45fc-a228-d0b055411448.jpg?im+w=720",
        title: "Entire homes",
        description:
          "Comfortable private places, with room for friends or famlily.",
      },
    ],
    card2: [
      {
        ...
        description:
          "Superhost with a stunning view of the beachside in Sunny Boutnrmouth",
        price: "£130/night",
      },
      {
        src:
  ...
  return (
    <div className="home">
      ...
      <div className="home_section">
        {cards.card1.map((el) => (
          <Card title={el.title} description={el.description} src={el.src} />
        ))}
      </div>
      <div className="home_section">
        {cards.card2.map((el) => (
